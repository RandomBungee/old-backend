...
import de.flamefoxes.user.CreateTeamUserRequest;
import de.flamefoxes.user.CreateTeamUserResponse;
import de.flamefoxes.user.FindTeamUserRequest;
import de.flamefoxes.user.FindTeamUserResponse;
import de.flamefoxes.user.TeamUser;
import de.flamefoxes.user.TeamUserServiceGrpc.TeamUserServiceBlockingStub;
import de.flamefoxes.user.UpdateTeamUserRequest;
import de.flamefoxes.user.UpdateTeamUserResponse;
